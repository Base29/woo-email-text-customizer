...
class WETCCore {
	...
	function wetcRegisterPluginOptions() {
		add_option( 'wetc_admin-cancelled-order_text', 'The order #%d from %s has been cancelled. The order was as 
		follows:' );
		add_option( 'wetc_admin-failed-order_text', 'Payment for order #%d from %s has failed. The order was as 
		follows:' );
		add_option( 'wetc_admin-new-order_text', 'You have received an order from %s. The order is as follows:' );
		add_option( 'wetc_customer-completed-order_text', 'Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:' );
		add_option( 'wetc_customer-new-account_text', 'Thanks for creating an account on %s. Your username is 
		<strong>%s</strong>' );
		add_option( 'wetc_customer-note_text', 'Hello, a note has just been added to your order:' );
		add_option( 'wetc_customer-on-hold-order_text', 'our order is on-hold until we confirm payment has been received. Your order details are shown below for your reference:' );
		add_option( 'wetc_customer-processing-order_text', 'Your order has been received and is now being processed. 
		Your order details are shown below for your reference:' );
		add_option( 'wetc_customer-refunded-order_text', 'Hi there. Your order on %s has been refunded.' );
		add_option( 'wetc_customer-reset-password_text', 'Someone requested that the password be reset for the following account:\n\nUsername: \n\nIf this was a mistake, just ignore this email and nothing will happen.\n\nTo reset your password, visit the following address:\n[ec_reset_password_link]' );
